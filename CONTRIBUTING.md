# Contributing to pkg-rpm-adreno
...
Development happens directly on branch c10s. Open a PR targeting c10s

## Submitting a pull request

1. Please read our [code of conduct](CODE-OF-CONDUCT.md) and [license](LICENSE.txt).
1. [Fork](https://github.com/qualcomm-linux/pkg-rpm-adreno/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-rpm-adreno.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-adreno.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-rpm-adreno/pulls) from your branch to `c10s`.
